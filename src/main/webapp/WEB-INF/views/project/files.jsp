        ...
        <div class="contents">
            ...
            <div class="file_list">
                <div class="file_list_index">
                    ...
                    <div class="file_list_fsize filetable">크기</div>
                    <div class="file_list_uname filetable">등록자</div>
                    <div class="file_list_fdate filetable" style="text-decoration: underline; font-weight:700; color:#111;'">최근 업로드순</div>
                </div>
                
                <c:if test="${empty flist}" >
                <div class="notfile">
                    <img src="${pageContext.request.contextPath}/resources/img/important.png" style="width:50px">
                    <h2>해당 경로에 폴더와 파일이 존재하지 않습니다.</h2>
                </div>
                </c:if>
			...
			/* $(".title_down").click(function(){
				...
				if(checkedinput!=0){
					...
					$(check).each(function () {
						...
						console.log(fname);
						$(".title_down").attr("href","${pageContext.request.contextPath}/files/download?fileName=" + fname);
						$(".title_down").get(0).click();
					})
				}
			}) */
				...
				if(arrow==="↓"){
					$.ajax({
						...
						success: function (list) {
						    ...
						    $(".file_list_fname").css("text-decoration","underline");
						    $(".file_list_fname").css("font-weight","700");
						    $(".file_list_fname").css("color","#111");

	...
	<div class="container">
		...
		<div class="page_section">
			...
			<div class="main_section">
				...
				<form action="/insert" method="post" enctype="text/plain">
				<div>
					문서형식
				...
				<div>
					...
					기안자
					<input type="text" name="apdrafter">
					기안 일시
					<input type="date" id="name" onchange="printName()" name="apdate">
				</div>
				<hr>
				...
				<table width="100%" align="center" cellpadding="0" cellspacing="0">
					<table width="100%" class="board-listheader" cellpadding="0" cellspacing="0">
						<tr>
							<td>프로젝트</td>
							<td colspan="3"><input type="text" name="apptitle" style="width: 90%; border: 0;"></td>
						</tr>
						<tr>
							<td>장소</td>
							<td>
								<input type="text" name="applace" style="width: 90%; border: 0;">
							</td>
							<td>일시</td>
							<td id="result"></td>
						</tr>
						<tr>
							...
							<td colspan="3">
								<textarea name="apcontent" style="resize: none; width: 90%; height: 100%; border: 0;"></textarea>
							</td>
						</tr>
						<tr>
							<td>결정사항</td>
							<td colspan="3"><input type="text" name="apdec" style="width: 90%; border: 0;"></td>
						</tr>
						<tr>
							<td>기타</td>
							<td colspan="3"><input type="text" name="apetc" style="width: 90%; border: 0;"></td>
						</tr>

					</table>
			</div>
			<div class="apwrite">
				<button type="button" id="apwritebtn" name="apwritebtn">기안 등록하기</button>

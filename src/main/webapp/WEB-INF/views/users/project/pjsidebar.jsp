...
<body>
	...
	C37.5,30.6,42.8,35.1,48.2,39.9z M1.8,40c5.4-4.9,10.6-9.6,15.9-14.3C12.4,20.5,7.2,15.5,1.8,10.2C1.8,20.2,1.8,30,1.8,40z" />
		...
		L21.515,8H5V6h1h17.485l5,7H58V15z M29.515,11l-5-7H8V2h18.485l5,7H58v2H29.515z" />
			...
			<li><a href="#"> <svg data-name="Layer 1"
						xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50">
                        <path
							d="M25.26,36.31l-4.79,4.28c-3.09,2.76-6.17,5.54-9.28,8.28-.3.26-.92.57-1.12.44a1.58,1.58,0,0,1-.54-1.17q0-21.63,0-43.25A4,4,0,0,1,13.89.5H36.78a4,4,0,0,1,4.28,4.28q0,21.67,0,43.34a1.57,1.57,0,0,1-.55,1.17c-.2.13-.82-.18-1.12-.44Q32.66,42.91,26,36.92C25.77,36.72,25.54,36.54,25.26,36.31Zm14.18,10.5c0-.47,0-.7,0-.93q0-20.54,0-41.09a2.45,2.45,0,0,0-2.75-2.71H13.94C12,2.1,11.08,3,11.08,5q0,20.5,0,41c0,.22,0,.44.08.8l.91-.79L24.29,35c.92-.82,1.05-.83,2,0l6.92,6.19Z" />
                    </svg> 담아둔 글
			</a></li>
			<li><a href="#"> <svg version="1.1"
						xmlns="http://www.w3.org/2000/svg"
